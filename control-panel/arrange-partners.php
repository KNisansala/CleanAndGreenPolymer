        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Arrange Partner Posts - <?= $CATEGORY->name; ?></h2>
                            <ul class="header-dropdown">
                                <li class="">
                                    <a href="manage-instructors.php?id=<?= $id; ?>">
                                        ...
                                        <div class="col-md-12 arrange-container">
                                            <ul id="sortable">
                                                ...
                                                if (count($instructors) > 0) {
                                                    foreach ($instructors as $key => $img) {
                                                ?>
                                                        <div class="col-md-3" style="list-style: none;">
                                                            <li class="ui-state-default">
                                                                <span class="number-class">(<?= $key + 1; ?>)</span>
                                                                <img class="img-responsive" src="../upload/instructor/<?= $img["image_name"]; ?>" alt="" />
