...
class Blog
{
    ...
    public function create()
    {
        ...
        $query = "INSERT INTO `blog_post` (`category`,`title`,`image_name`,`description`,`created_at`,`sort`) VALUES  ('"
            . $this->category . "','"
            . $this->title . "', '"
            . $this->image_name . "', '"
            . $this->description . "', '"
    ...
    public function getAllWithLimit($pageLimit, $setLimit)
    {
        ...
        $query = "SELECT * FROM `blog_post` ORDER BY sort ASC LIMIT " . $pageLimit . " , " . $setLimit . "";
    ...
    public function delete()
    {
        ...
        $query = 'DELETE FROM `blog_post` WHERE id="' . $this->id . '"';
    ...
    {
        $allPhotos = BlogPhoto::getBlogPhotosByBlog($this->id);

        foreach ($allPhotos as $photo) {
            $PHOTO = new BlogPhoto($photo["id"]);
            $PHOTO->id = $photo["id"];
            $PHOTO->delete();
        }
    }
    ...
    public function getBlogsByCategory($category)
    {
        ...
        $query = 'SELECT * FROM `blog_post` WHERE category="' . $category . '" ORDER BY sort ASC';
    ...
    public function getBlogsByCategoryWithLimit($category, $pageLimit, $setLimit)
    {

        $query = 'SELECT * FROM `blog_post` WHERE category="' . $category . '" ORDER BY sort ASC LIMIT ' . $pageLimit . ' , ' . $setLimit . '';
    ...
    public function arrange($key, $img)
    {
        ...
        $query = "UPDATE `blog_post` SET `sort` = '" . $key . "'  WHERE id = '" . $img . "'";
        $db = new Database();
        $result = $db->readQuery($query);
        return $result;
    }
    ...
    public function search($category, $keyword, $pageLimit, $setLimit)
    {
        ...
        $query = "SELECT * FROM `blog_post` $where ORDER BY `sort` ASC LIMIT " . $pageLimit . " , " . $setLimit . "";
    ...
    public function showPagination($category, $keyword, $per_page, $page)
    {
        ...
        $page_url = "?";
        $query = "SELECT COUNT(*) as totalCount FROM `blog_post`  $where  ORDER BY `sort` asc";
