...
<body class="theme-red">
                                                    ...
                                                    <ol class="dd-list" id="dd-list">
                                                        ...
                                                        ?>
                                                                <li class="dd-item dd3-item" data-id="13">
                                                                    ...
                                                                    <div class="dd3-content">(<?php echo $key + 1; ?>) &ensp; Product Category : &ensp; <?php echo $img['name']; ?></div>
    ...
    <script src="js/product-category.js" type="text/javascript"></script>
    <script>
        $(function() {
            $("#dd-list").sortable();
