        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Arrange Locations - <?= $SUBCATEGORY->name; ?></h2>
                            <ul class="header-dropdown">
                                <li class="">
                                    <a href="manage-listings.php?id=<?= $id; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 arrange-container">
                                            <ul id="sortable">
                                                <?php
                                                if (count($listings) > 0) {
                                                    foreach ($listings as $key => $img) {
                                                ?>
                                                        <div class="col-md-3" style="list-style: none;">
                                                            <li class="ui-state-default">
                                                                <span class="number-class">(<?= $key + 1; ?>)</span>
                                                                <img class="img-responsive" src="../upload/listing/<?= $img["image_name"]; ?>" alt="" />
