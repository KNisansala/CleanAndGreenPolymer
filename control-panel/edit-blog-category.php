...
$BLOG_CATEGORY = new BlogCategory($id);
?>
...
<body class="theme-red">
                            ...
                            <form class="form-horizontal" method="post" id="form-data" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="name" class="form-control" value="<?php echo $BLOG_CATEGORY->name; ?>" name="name" required="TRUE">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" id="id" value="<?php echo $BLOG_CATEGORY->id; ?>" name="id" />
    ...
    <script src="js/blog-category.js" type="text/javascript"></script>
</body>
