...
$CATEGORY = new PartnerCategory($id);
?>
<!DOCTYPE html>
<html>
...
<body class="theme-red">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Create Partner Posts - <?= $CATEGORY->name; ?></h2>
                            <ul class="header-dropdown">
                                <li class="">
                                    <a href="manage-partner-categories.php?id=<?= $CATEGORY->id; ?>">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Manage Partner Posts - <?= $CATEGORY->name; ?></h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                <?php
                                $partners = Partner::getPartnersByCategory($id);
                                if (count($partners) > 0) {
                                    foreach ($partners as $key => $partner) {
                                ?>
                                        <div class="col-md-3" id="div<?= $partner['id']; ?>">
                                            <div class="photo-img-container">
                                                <img src="../upload/partner/<?= $partner['image_name']; ?>" class="img-responsive ">
                                            </div>
                                            <div class="img-caption">
                                                <p class="maxlinetitle"><?= $partner['name']; ?></p>
                                                <div class="d">
                                                    <a href="edit-partner.php?id=<?= $partner['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn"></button></a> |
                                                    <a href="#" class="delete-partner" data-id="<?= $partner['id']; ?>"> <button class="glyphicon glyphicon-trash delete-btn"></button></a> |
                                                    <a href="arrange-partners.php?id=<?= $partner['category']; ?>"> <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                    ...
                                    ?>
                                    <b style="padding-left: 15px;">No any partners.</b>
                                <?php } ?>
    ...
    <script src="delete/js/partner.js" type="text/javascript"></script>
