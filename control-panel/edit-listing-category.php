...
$LISTING_CATEGORY = new ListingCategory($id);
?>
                            ...
                            <form class="form-horizontal" method="post" id="form-data" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="name" class="form-control" value="<?php echo $LISTING_CATEGORY->name; ?>" name="name" required="TRUE">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" id="id" value="<?php echo $LISTING_CATEGORY->id; ?>" name="id" />
