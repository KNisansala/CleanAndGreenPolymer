        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Edit Service Photo</h2>
                            <ul class="header-dropdown">
                                <li class="">
                                    <a href="view-service-photos.php?id=<?= $SERVICE_PHOTO->service; ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <img src="../upload/service/gallery/thumb/<?php echo $SERVICE_PHOTO->image_name; ?>" id="image" class="img img-responsive img-thumbnail" name="image" alt="old image">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
