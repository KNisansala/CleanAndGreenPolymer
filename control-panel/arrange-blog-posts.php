...
<head>
    ...
    <title>Blog Posts || Control Panel || Synotec Holdings</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Arrange Blog Posts - <?= $CATEGORY->name; ?></h2>
                            <ul class="header-dropdown">
                                <li class="">
                                    <a href="manage-blog-posts.php?id=<?= $id; ?>">
                                                ...
                                                ?>
                                                        <div class="col-md-3" style="list-style: none;">
                                                            <li class="ui-state-default">
                                                                ...
                                                                <img class="img-responsive" src="../upload/blog-post/<?= $img["image_name"]; ?>" alt="" />
