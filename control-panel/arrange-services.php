...
<head>
    ...
    <title>Service || Control Panel || Synotec Holdings</title>
    <!-- Favicon-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 arrange-container">
                                            <ul id="sortable">
                                                <?php
                                                if (count($services) > 0) {
                                                    foreach ($services as $key => $img) {
                                                ?>
                                                        <div class="col-md-3" style="list-style: none;">
                                                            <li class="ui-state-default">
                                                                <span class="number-class">(<?= $key + 1; ?>)</span>
                                                                <img class="img-responsive" src="../upload/service/<?= $img["image_name"]; ?>" alt="" />
