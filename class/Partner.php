...
class Partner
{
    ...
    public function create()
    {
        ...
        $query = "INSERT INTO `partner` (`category`,`name`,`experience`,`district`,`city`,`phone`,`email`,`image_name`,`sort`) VALUES  ('"
            . $this->category . "','"
            . $this->name . "', '"
            . $this->experience . "', '"
            . $this->district . "', '"
    ...
    public function all()
    {
        ...
        $query = "SELECT * FROM `partner` ORDER BY sort ASC";
        $db = new Database();
        $result = $db->readQuery($query);
        $array_res = array();
    ...
    public function getAllWithLimit($pageLimit, $setLimit)
    {
        ...
        $query = "SELECT * FROM `partner` ORDER BY sort ASC LIMIT " . $pageLimit . " , " . $setLimit . "";
    ...
    {
        unlink(Helper::getSitePath() . "upload/partner/" . $this->imageName);

        $query = 'DELETE FROM `partner` WHERE id="' . $this->id . '"';
    ...
    public function getPartnersByCategory($category)
    {

        $query = 'SELECT * FROM `partner` WHERE `category` ="' . $category . '" ORDER BY sort ASC';
    ...
    public function getPartnersByCategoryWithLimit($category, $pageLimit, $setLimit)
    {

        $query = 'SELECT * FROM `partner` WHERE `category` ="' . $category . '" ORDER BY `sort` ASC LIMIT ' . $pageLimit . ' , ' . $setLimit . '';
    ...
    public function arrange($key, $img)
    {
        ...
        $query = "UPDATE `partner` SET `sort` = '" . $key . "'  WHERE id = '" . $img . "'";
        $db = new Database();
        $result = $db->readQuery($query);
        return $result;
    }
    ...
    public function search($category, $district, $keyword, $pageLimit, $setLimit)
    {
        ...
        $query = "SELECT * FROM `partner` $where ORDER BY `sort` ASC LIMIT " . $pageLimit . " , " . $setLimit . "";
    ...
    public function showPagination($id, $district, $keyword, $per_page, $page)
    {
        ...
        $page_url = "?";
        $query = "SELECT COUNT(*) as totalCount FROM `partner`  $where  ORDER BY `sort` asc";
