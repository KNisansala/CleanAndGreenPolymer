$(document).ready(function () {
    ...
    $("#create").click(function (event) {
        ...
        } else if (!$('#start-date').val() || $('#start-date').val().length === 0) {
            swal({
                title: "Error!",
                text: "Please enter startdate..!",
                type: 'error',
                timer: 1500,
                showConfirmButton: false
            });
        } else if (!$('#end-date').val() || $('#end-date').val().length === 0) {
            swal({
                title: "Error!",
    ...
    $("#arrange").click(function (event) {
        ...
        $.ajax({
            ...
            success: function (result) {
                swal({
                    title: "Success!",
                    text: "Event were arranged successfully!.....!",
                    type: 'success',
                    timer: 2000,
                    showConfirmButton: false
                }, function () {
