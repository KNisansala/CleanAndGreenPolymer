        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Arrange Location Sub Categories - <?= $CATEGORY->name; ?></h2>
                            <ul class="header-dropdown">
                                <li class="">
                                    <a href="manage-listing-sub-categories.php?id=<?= $id; ?>">
                                                ...
                                                <div class="dd nestable-with-handle">
                                                    <ol class="dd-list" id="dd-list">
                                                        ...
                                                        if (count($sub_categories) > 0) {
                                                            foreach ($sub_categories as $key => $img) {
                                                        ?>
                                                                <li class="dd-item dd3-item" data-id="13">
                                                                    <div class="dd-handle dd3-handle"></div>
                                                                    <div class="dd3-content">(<?php echo $key + 1; ?>) &ensp; Listing Sub Category : &ensp; <?php echo $img['name']; ?></div>
                                                            ...
                                                            ?>
                                                            <b>No any location sub categories.</b>
                                                        <?php } ?>
                                                    </ol>
                                                </div>
                                                <div class="row">
