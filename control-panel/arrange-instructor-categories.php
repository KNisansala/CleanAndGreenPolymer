        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Arrange Instructor Categories</h2>
                                            ...
                                            <div class="clearfix m-b-20">
                                                <div class="dd nestable-with-handle">
                                                    <ol class="dd-list" id="dd-list">
                                                        <?php
                                                        $categories = InstructorCategory::all();
                                                        if (count($categories) > 0) {
                                                            foreach ($categories as $key => $img) {
                                                        ?>
                                                                <li class="dd-item dd3-item" data-id="13">
                                                                    <div class="dd-handle dd3-handle"></div>
                                                                    <div class="dd3-content">(<?php echo $key + 1; ?>) &ensp; Instructor Category : &ensp; <?php echo $img['name']; ?></div>
