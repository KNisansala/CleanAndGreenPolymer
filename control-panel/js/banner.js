            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    swal({
                        ...
                        setTimeout(function () {
                            window.location.replace("create-banner.php");
                        }, 1500);
                    });
                },
                cache: false,
            ...
            $.ajax({
                ...
                success: function (result) {
                    swal({
                        ...
                        setTimeout(function () {
                            window.location.replace("edit-banner.php?id=" + result.id);
                        }, 1500);
                    });
                },
                cache: false,
        ...
        $('.box').css('z-index', '9999');
            ...
            $.ajax({
                ...
                success: function (result) {
                    swal({
                        title: "Success!",
                        text: "Banner photos arranged successfully!.....!",
                        type: 'success',
                        timer: 2000,
                        showConfirmButton: false
                    }, function () {
